...
class Sensitivity(Metric):
    ...
    def evaluate(
        ...
        explain_func: Callable[[torch.Tensor, torch.Tensor], torch.Tensor],
    ) -> torch.Tensor:
        ...
        for input, target, attr in zip(inputs, targets, attributions):
            ...
            perturbed_attr = explain_func(perturbed, target.repeat(self.n_iter))
...
#         explain_func (Callable): The explainer function providing attributions from inputs and targets.
