...
class Objective:
    ...
    def __call__(self, trial: Trial) -> float:
        ...
        # suggest explainer
        explainer = suggest(
            trial, self.explainer, self.modality, key=self.EXPLAINER_KEY
        )
        ...
        for pp, modality in zip(
            ...
            force_params = {}
            if isinstance(explainer, (Lime, KernelShap)) and isinstance(
        ...
        metric = metric.set_postprocessor(postprocessor)
