...
class SklearnClassifier(metaclass=SubclassMeta):
    __subclass__ = (ClassifierMixin)


class SklearnRegressor(metaclass=SubclassMeta):
    __subclass__ = (RegressorMixin)

class SklearnModel(metaclass=SubclassMeta):
    __subclass__ = (
        SklearnRegressor,
        SklearnClassifier,
    )
