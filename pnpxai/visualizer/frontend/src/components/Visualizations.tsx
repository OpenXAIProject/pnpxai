...
const Visualizations: React.FC<{ 
  ...
  const explainerNickname = [
    ...
    { "name": "LRPUniformEpsilon", "nickname": "LRP" },
    { "name": "LRPEpsilonPlus", "nickname": "LRP Epsilon Plus" },
    { "name": "LRPEpsilonAlpha2Beta1", "nickname": "LRP Epsilon Alpha Beta" },
    { "name": "LRPEpsilonGammaBox", "nickname": "LRP Epsilon Gamma Box" },
    { "name": "Gradient", "nickname": "Gradient" },
    { "name": "GradientXInput", "nickname": "Gradient X Input" },
    { "name": "SmoothGrad", "nickname": "Smooth Grad"},
    { "name": "VarGrad", "nickname": "Var Grad" },
    { "name": "AttentionRollout", "nickname": "Attention Rollout" },
    { "name": "TransformerAttribution", "nickname": "Transformer Attribution" },
